              ...
              <div class="row">
                ...
                <td class="col-sm-6 text-center"><h4 class="addition_title"><?php echo display('addition')?></h4><br>
                 ...
                 foreach ($slname as $ab){
                  ?>
                  <tr><th class="padten"><?php echo $ab->sal_name ;?>(%)</th><td><input type="number" name="amount[<?php echo $ab->salary_type_id; ?>]" class="form-control addamount" onkeyup="salarySetupsummary()" id="add_<?php echo $x;?>"></td></tr>
                  <?php
                $x++;}
                ?>
              </table>
            ...
            <td class="col-sm-6 text-center"><h4 class="addition_title"><?php echo display('deduction')?></h4><br>
              <table id="dduct">
                ...
                foreach ($sldname as $row){
                  ?>
                  <tr><th class="padten"><?php echo $row->sal_name ;?> (%)</th><td><input type="number" name="amount[<?php echo $row->salary_type_id; ?>]" onkeyup="salarySetupsummary()" class="form-control deducamount" id="dd_<?php echo $y;?>"></td></tr><?php
               $y++; }
                ?>
                <tr><th class="padten"><?php echo display('tax')?> (%)</th><td><input type="number" name="amount[]"  onkeyup="salarySetupsummary()"  class="form-control deducamount" id="taxinput"></td><td class="padten"><input type="checkbox" name="tax_manager" id="taxmanager" onchange='handletax(this);' value="1">Tax Manager</td></tr>

...
<div class="row">
   ...
   <option value="<?php echo $acc1->HeadCode;?>" <?php if($upcrvoucher->COAID == $acc1->HeadCode){
         ...
         <?php }?>
                                        ...
                                        <td><input type="number" name="txtAmount[]" value="<?php echo $upcrvoucher->Credit ?>" class="form-control total_price text-right"  id="txtAmount_<?php echo $sl; ?>" onkeyup="calculationCreditv(<?php echo $sl; ?>)" >
                                           </td>
                                       <td>

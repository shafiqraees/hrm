            ...
            <div class="panel panel-bd">
                ...
                <?php echo form_open_multipart("dashboard/user/form/$user->id") ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <?php echo form_dropdown('employee_id',$empl,(!empty($empinfo->employee_id)?$empinfo->employee_id:null),'class="form-control" style="width:100%" onchange="EmployeeinUser(this.value)"') ?>

                ...
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                $def_mods = ['accounts','asset','addon','attendance','autoupdate','award','bank','dashboard','department','employee','expense','income','leave','loan','noticeboard','payroll','recruitment','reports','rewardpoint','tax','template'];
                                if (is_array($map))
